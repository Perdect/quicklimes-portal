...
ok('registry is gst, modern, business, detailed, industrial, premium — in that order', T.TEMPLATES.map(t => t.id).join(',') === 'gst,modern,business,detailed,industrial,premium');
