...
ok('the seal carries the firm name, never an invented registration', /DESHWALI MINERALS/.test(h.slice(h.indexOf('<svg class="seal"'))) && !/Regd\. No|Reg\. No/.test(h));
