...
ok('totals: the figure column fits its widest figure (width:1%, nowrap) so each label ends close to its figure — owner, 18-09-2026', /\.tot td\.v\{[^}]*width:1%;white-space:nowrap\}/.test(h) && !/\.tot td\.l\{[^}]*width:\d+%/.test(h));
