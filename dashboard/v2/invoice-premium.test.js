...
ok('the whole page is set at the reference\'s density: body 8.7px, box names 10.5px, table cells 8.7px, totals rows at half pads (2.5px, owner: "reduce between spacing 50%"), terms rows 6px pads', /body\{[^}]*font-size:8\.7px/.test(h) && /\.box \.nm\{font-size:10\.5px/.test(h) && /\.it td\{padding:7px 7px;[^}]*font-size:8\.7px/.test(h) && /\.tot td\{padding:2\.5px 10px/.test(h) && /\.tc td\{padding:6px 0/.test(h));
