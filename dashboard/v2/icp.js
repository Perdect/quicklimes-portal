...
(function () {
  ...
  var CSS = [
    ...
    '.icp-stat{background:var(--ql-neutral-50);border:1px solid var(--ql-border);border-radius:10px;padding:8px 10px}',
    ...
    '.icp-tab.on{background:var(--ql-brand-50);border-color:var(--ql-brand-600);color:var(--ql-brand-600);font-weight:600}',
    ...
    '.icp-facts{display:flex;gap:12px;flex-wrap:wrap;margin-top:5px;font-size:11.5px;color:var(--ql-text-muted)}',
    '.icp-act{flex:none;display:flex;gap:6px;align-items:center}',
    '.icp-note{font-size:12px;border:1px solid var(--ql-border);background:var(--ql-neutral-50);border-radius:9px;padding:8px 11px;margin-bottom:9px;line-height:1.5}',
    ...
    '.icp-t th{background:var(--ql-neutral-50);text-align:left;padding:8px 10px;font-size:10.5px;text-transform:uppercase;letter-spacing:.05em;color:var(--ql-text-secondary);border-bottom:1px solid var(--ql-border);white-space:nowrap}',
