...
ok('the seed carries the stamp line and the website the Premium design prints', /sealText: 'BORUNDA, GOTAN, RAJASTHAN', website: 'www\.deshwaliminerals\.com'/.test(src) && /sealText: seller\.sealText \|\| '', website: seller\.website \|\| ''/.test(src));
