...
(function () {
  ...
  function heroHTML() {
    ...
    // Title text removed per request — the topbar breadcrumb already names the
    // page. Empty left keeps the action buttons right-aligned.
    return `<div class="qx-hero">
      <div class="qx-hero-l"></div>
