...
/* ── 4. the quotation document prints the entered quantity, the rate per its unit, the priced amount ── */
{
  ...
  ok('a buyer whose stored state contradicts the GSTIN (Balaji: "Rajasthan (08)" on a 27… GSTIN, spaces in the number) prints Maharashtra (27), the clean GSTIN, and IGST', (function () { const x = D.quotationHTML({ no: 'Q', date: '2026-09-19', validUntil: '2026-10-03', gstR: 5, items: [{ product: 'Quick Lime', qty: 42, unit: 'Ton', rate: 5500, rateUnit: 'Ton' }] }, { name: 'Balaji', address: 'Sangli, MAHARASHTRA 416415', state: 'Rajasthan (08)', gstin: '27CMV PC280 8M1ZK' }, { name: 'DESHWALI MINERALS', gstin: '08NLIPS9801K1Z5', state: 'Rajasthan (08)', address: 'Borunda', city: 'Borunda' }, {}); return /Maharashtra \(27\)/.test(x) && /27CMVPC2808M1ZK/.test(x) && !/27CMV PC280/.test(x) && /IGST on goods @ 5%/.test(x) && !/CGST/.test(x); })());
