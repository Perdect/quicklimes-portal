...
(function () {
  ...
  var CSS = [
    ...
    '.ch-search input{width:100%;padding:7px 11px;border:1px solid var(--ql-border);border-radius:20px;font:inherit;font-size:13px;background:var(--ql-bg-subtle,#f8fafc);color:inherit}',
    ...
    '.ch-li:hover{background:var(--ql-bg-subtle,#f8fafc)}.ch-li.on{background:var(--ql-primary-50,#eff6ff)}',
    '.ch-av{width:38px;height:38px;border-radius:50%;background:var(--ql-primary-600,#2563EB);color:#fff;display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:700;flex:none;position:relative}',
    ...
    '.ch-when{font-size:10.5px;color:var(--ql-text-tertiary,#94a3b8);flex:none}',
    ...
    '.ch-you{color:var(--ql-text-tertiary,#94a3b8)}',
    ...
    '.ch-thread{flex:1;overflow:auto;padding:14px;background:var(--ql-bg-subtle,#f8fafc);display:flex;flex-direction:column;gap:6px}',
    ...
    '.ch-who{font-size:11px;font-weight:700;color:var(--ql-primary-600,#2563EB);margin-bottom:2px}',
    ...
    '.ch-in textarea{flex:1;resize:none;border:1px solid var(--ql-border);border-radius:18px;padding:9px 13px;font:inherit;font-size:13.5px;max-height:120px;background:var(--ql-bg-subtle,#f8fafc);color:inherit}',
    ...
    '.ch-mut{color:var(--ql-text-tertiary,#94a3b8);font-size:11.5px}',
